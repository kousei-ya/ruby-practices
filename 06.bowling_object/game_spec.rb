...
describe Game do
  ...
  example do
    ...
    expect(game.calculate).to eq 139
  end

  example do
    game = described_class.new('6,3,9,0,0,3,8,2,7,3,X,9,1,8,0,X,X,X,X')
    expect(game.calculate).to eq 164
  end
